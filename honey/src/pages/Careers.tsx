...
const Careers: React.FC = () => {
  ...
  <div className="fixed inset-0 flex items-center justify-center p-4 sm:p-6 lg:p-8">
    <Dialog.Panel className="mx-auto w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl rounded bg-white p-4 sm:p-6 lg:p-8">
      ...
      <button
        onClick={closeModal}
        className="mt-4 w-full sm:w-auto text-white bg-red-600 hover:bg-red-500 px-4 py-2 rounded"
      >
        Zamknij
      </button>
    </Dialog.Panel>
